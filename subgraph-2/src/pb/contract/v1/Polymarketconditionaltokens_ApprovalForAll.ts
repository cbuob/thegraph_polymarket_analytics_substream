...
export class Polymarketconditionaltokens_ApprovalForAll {
  static encode(
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Polymarketconditionaltokens_ApprovalForAll {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Polymarketconditionaltokens_ApprovalForAll();
