...
export class Polymarketconditionaltokens_TransferSingle {
  static encode(
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Polymarketconditionaltokens_TransferSingle {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Polymarketconditionaltokens_TransferSingle();
