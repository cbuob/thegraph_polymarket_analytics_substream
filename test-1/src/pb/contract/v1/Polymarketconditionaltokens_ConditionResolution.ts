...
export class Polymarketconditionaltokens_ConditionResolution {
  static encode(
    ...
    const payoutNumerators = message.payoutNumerators;
    if (payoutNumerators.length !== 0) {
      for (let i: i32 = 0; i < payoutNumerators.length; ++i) {
        writer.uint32(74);
        writer.string(payoutNumerators[i]);
      }
    }
  }
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Polymarketconditionaltokens_ConditionResolution {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Polymarketconditionaltokens_ConditionResolution();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          message.payoutNumerators.push(reader.string());
          break;
  ...
  constructor(
    ...
    this.payoutNumerators = payoutNumerators;
  }
}
