...
export class Polymarketconditionaltokens_PositionsMerge {
  static encode(
    ...
    writer.uint32(42);
    writer.bytes(message.stakeholder);
    ...
    if (partition.length !== 0) {
      for (let i: i32 = 0; i < partition.length; ++i) {
        writer.uint32(74);
        writer.string(partition[i]);
      }
    }
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Polymarketconditionaltokens_PositionsMerge {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Polymarketconditionaltokens_PositionsMerge();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          message.stakeholder = reader.bytes();
          break;
        ...
        case 9:
          message.partition.push(reader.string());
          break;
  ...
  constructor(
    ...
    stakeholder: Uint8Array = new Uint8Array(0),
