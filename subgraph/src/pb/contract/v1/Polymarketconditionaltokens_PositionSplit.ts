...
export class Polymarketconditionaltokens_PositionSplit {
  static encode(
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Polymarketconditionaltokens_PositionSplit {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Polymarketconditionaltokens_PositionSplit();
